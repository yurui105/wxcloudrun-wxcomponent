...
func GoodsAdd(ctx *gin.Context) {
	...
	data, err := app.Goods.Add(ctx.Request.Context(), products)
	if err != nil {
...
func GoodsUpdate(ctx *gin.Context) {
	...
	data, err := app.Goods.Update(ctx.Request.Context(), products)
	if err != nil {
		ctx.String(http.StatusBadRequest, err.Error())
		return
	}
...
func GoodsStatus(c *gin.Context) {
	...
	res, err := app.Goods.Status(c.Request.Context(), statusTicket)
...
func GoodsGet(c *gin.Context) {
	...
	res, err := app.Goods.Get(c.Request.Context(), &request.RequestProductGet{
...
func GoodsList(c *gin.Context) {
	...
	res, err := app.Goods.List(c.Request.Context(), context, page, size)
